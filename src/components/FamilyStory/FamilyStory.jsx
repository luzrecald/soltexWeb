...
export default function FamilyStory() {
  return (
    <section id="empresa" className="story-section" aria-labelledby="story-title">
      <div className="story-container">
        <div className="story-surface">
          ...
          <div className="story-content">
            ...
            <p className="story-text">
              La incorporación de tecnología, la optimización de procesos y la ampliación de la
